...
- Controller : quản lý nhận yêu cầu từ Routing(định tuyến) , xử lý  và phản hồi thông tin
...
- Muốn hiển thị thông tin thì tạo thư mục trong Vỉew trùng tên với tên Controller vừa tạo, 
  Các action hiển thị dưới dạng file .cshtml